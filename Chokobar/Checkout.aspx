<%@ Page Title="" Language="C#" MasterPageFile="~/User.Master" AutoEventWireup="true" CodeBehind="Checkout.aspx.cs" Inherits="Chokobar.Checkout" %>
                        ...
                        <div class="col-lg-4 col-md-6">
                            <div class="checkout__order">
                                ...
                                <ul>
                                    ...
                                    <li><%=db.reader["name"] %> <span>$<%=db.reader["price"] %></span></li>
                                    <%}
